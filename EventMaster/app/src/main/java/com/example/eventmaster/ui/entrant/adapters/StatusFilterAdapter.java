...
/**
 * Simple single-item adapter that renders the lifecycle filter chips (All/Open/Closed/Done)
...
public class StatusFilterAdapter extends RecyclerView.Adapter<StatusFilterAdapter.StatusViewHolder> {
    ...
    public StatusFilterAdapter(@NonNull StatusFilterListener listener) {
    ...
    public StatusViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.entrant_item_status_filter, parent, false);
